#
#  Be sure to run `pod spec lint AppsPortfolio.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mahmud Ahsan"
  # s.authors            = { "Mahmud Ahsan" => "mahmud@thinkdiff.net" }
  ...
  # s.resource  = "icon.png"
  s.resources = "AppsPortfolio/AppsPortfolio/Data/**/*"
